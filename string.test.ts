...
const test_SplitSingleLineLimits21: Split<SINGLE_LINE_LIST, " ">[10] =
  "OPTION011";
// @ts-expect-error
const test_SplitSingleLineLimits22: Split<SINGLE_LINE_LIST, " ">[10] =
  "OPTION010"; // ERROR: Type '"OPTION010"' is not assignable to type '"OPTION011"'.ts(2322)
const test_SplitSingleLineLimits3: Split<SINGLE_LINE_LIST, " ">[99] =
  "OPTION100";
const test_SplitSingleLineLimits4: Split<SINGLE_LINE_LIST, " ">[998] =
  "OPTION999";
...
// @ts-expect-error
const test_SplitUnionLimits6: Unique<Split<SINGLE_LINE_LIST, " ">> =
  "OPTION000";
